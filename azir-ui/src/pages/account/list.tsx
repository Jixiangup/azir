...
import {list as queryUsers, updateIsAdmin} from '@/services/azir/user';
...
const List: React.FC = () => {
  ...
  const setAdmin = (id: number | undefined) => {
